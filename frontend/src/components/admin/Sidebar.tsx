      ...
      >
        <div className="h-full p-4 text-white">
          <div className="flex justify-between items-center mb-10">
            <Link to={'/'} className="flex gap-2 items-center text-3xl font-bold">
              {' '}
              <FaBrain className="text-4xl text-indigo-500" />
              <h1 className="bg-gradient-to-r from-indigo-500 via-pink-400 to-pink-500 text-transparent bg-clip-text text-5xl max-md:text-4xl font-semibold">
                Quizly
              </h1>
            </Link>
